...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="/livestream/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="row col-md-12">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="live_id" name="live_id" value="{{old('live_id')}}">
            ...
            <button type="submit" class="btn btn-sila btn-sm">Add Livestream</button>
