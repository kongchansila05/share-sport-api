    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="px-3 py-5 bg-gradient-sila text-white">.bg-gradient-sila</div>
                <div class="px-3 py-5 bg-gradient-best text-white">.bg-gradient-best</div>
                <div class="px-3 py-5 bg-gradient-lest text-white">.bg-gradient-lest</div>
